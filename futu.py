...
# List of symbols you want to match
symbols_to_match = """
...
for page in range(1, 10):
    url = f"https://api.coingecko.com/api/v3/coins/markets?vs_currency=inr&order=volume_desc&per_page=250&page={page}&sparkline=false&locale=en&precision=2&price_change_percentage=1h"
...
# Filter coins based on your symbol list
matched_coins = [coin for coin in all_coins if coin['symbol'].upper() in symbols_to_match]

print(f"Total matched coins: {len(matched_coins)}")
